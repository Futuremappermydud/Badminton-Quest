...
namespace HMUI {
  ...
  class InputFieldDataBinder : public ::Il2CppObject {
    public:
    // Nested type: HMUI::InputFieldDataBinder::$$c__DisplayClass2_0_2<T1, T0>
    ...
    void AddBindings(System::Collections::Generic::List_1<System::Tuple_4<UnityEngine::UI::InputField*, T0, System::Func_2<::Il2CppString*, T1>*, System::Func_2<T1, ::Il2CppString*>*>*>* bindingData) {
      static_assert(std::is_convertible_v<T0, GlobalNamespace::IObservableChange*> && std::is_convertible_v<T0, GlobalNamespace::IValue_1<T1>*>);
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "AddBindings", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T0>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T1>::get()}, bindingData));
    }
    ...
    void AddStringBindings(System::Collections::Generic::List_1<System::Tuple_2<UnityEngine::UI::InputField*, T>*>* bindingData) {
      static_assert(std::is_convertible_v<T, GlobalNamespace::IObservableChange*> && std::is_convertible_v<T, GlobalNamespace::IValue_1<::Il2CppString*>*>);
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "AddStringBindings", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, bindingData));
    }
