...
namespace GlobalNamespace {
  ...
  class CachedMediaAsyncLoader : public UnityEngine::MonoBehaviour, public GlobalNamespace::IMediaAsyncLoader, public GlobalNamespace::IAudioClipAsyncLoader, public GlobalNamespace::IImageAsyncLoader {
    public:
