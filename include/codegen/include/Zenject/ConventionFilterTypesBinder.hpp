...
namespace Zenject {
  ...
  class ConventionFilterTypesBinder : public Zenject::ConventionAssemblySelectionBinder {
    ...
    Zenject::ConventionFilterTypesBinder* DerivingFromOrEqual() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::ConventionFilterTypesBinder*>(this, "DerivingFromOrEqual", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    Zenject::ConventionFilterTypesBinder* DerivingFrom() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::ConventionFilterTypesBinder*>(this, "DerivingFrom", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    Zenject::ConventionFilterTypesBinder* WithAttribute() {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::ConventionFilterTypesBinder*>(this, "WithAttribute", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    Zenject::ConventionFilterTypesBinder* WithoutAttribute() {
      static_assert(std::is_convertible_v<T, System::Attribute*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::ConventionFilterTypesBinder*>(this, "WithoutAttribute", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    Zenject::ConventionFilterTypesBinder* WithAttributeWhere(System::Func_2<T, bool>* predicate) {
      static_assert(std::is_convertible_v<T, System::Attribute*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::ConventionFilterTypesBinder*>(this, "WithAttributeWhere", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, predicate));
    }
