...
namespace System::Collections {
  ...
  class SortedList::SortedListEnumerator : public ::Il2CppObject, public System::Collections::IDictionaryEnumerator, public System::Collections::IEnumerator, public System::ICloneable {
    public:
