...
namespace Zenject {
  ...
  class MemoryPoolMaxSizeBinder_1 : public Zenject::MemoryPoolExpandBinder_1<TContract> {
    ...
    Zenject::MemoryPoolExpandBinder_1<TContract>* WithMaxSize(int size) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<Zenject::MemoryPoolExpandBinder_1<TContract>*>(this, "WithMaxSize", size));
    }
    ...
    static MemoryPoolMaxSizeBinder_1<TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo, Zenject::MemoryPoolBindInfo* poolBindInfo) {
      return (MemoryPoolMaxSizeBinder_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MemoryPoolMaxSizeBinder_1<TContract>*>::get(), bindContainer, bindInfo, factoryBindInfo, poolBindInfo));
    }
