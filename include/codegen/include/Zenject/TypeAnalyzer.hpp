...
namespace Zenject {
  ...
  class TypeAnalyzer : public ::Il2CppObject {
    ...
    static bool ShouldAllowDuringValidation() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<bool>("Zenject", "TypeAnalyzer", "ShouldAllowDuringValidation", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    template<class T>
    static bool HasInfo() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<bool>("Zenject", "TypeAnalyzer", "HasInfo", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    static Zenject::InjectTypeInfo* GetInfo() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::InjectTypeInfo*>("Zenject", "TypeAnalyzer", "GetInfo", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    static Zenject::InjectTypeInfo* TryGetInfo() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::InjectTypeInfo*>("Zenject", "TypeAnalyzer", "TryGetInfo", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
