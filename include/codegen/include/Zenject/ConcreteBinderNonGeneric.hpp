...
namespace Zenject {
  ...
  class ConcreteBinderNonGeneric : public Zenject::FromBinderNonGeneric {
    ...
    Zenject::FromBinderNonGeneric* To() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::FromBinderNonGeneric*>(this, "To", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TConcrete>::get()}));
    }
