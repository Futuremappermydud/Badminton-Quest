...
namespace UnityEngine::Animations {
  ...
  class AnimationPlayableExtensions : public ::Il2CppObject {
    ...
    static void SetAnimatedProperties(U playable, UnityEngine::AnimationClip* clip) {
      ...
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod("UnityEngine.Animations", "AnimationPlayableExtensions", "SetAnimatedProperties", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get()}, playable, clip));
    }
