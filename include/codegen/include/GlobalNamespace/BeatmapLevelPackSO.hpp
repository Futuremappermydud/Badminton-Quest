...
namespace GlobalNamespace {
  ...
  class BeatmapLevelPackSO : public GlobalNamespace::PersistentScriptableObject, public GlobalNamespace::IBeatmapLevelPack, public GlobalNamespace::IAnnotatedBeatmapLevelCollection {
    public:
