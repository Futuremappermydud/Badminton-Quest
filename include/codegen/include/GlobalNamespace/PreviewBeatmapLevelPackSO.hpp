...
namespace GlobalNamespace {
  ...
  class PreviewBeatmapLevelPackSO : public GlobalNamespace::PersistentScriptableObject, public GlobalNamespace::IBeatmapLevelPack, public GlobalNamespace::IAnnotatedBeatmapLevelCollection {
    public:
