  ...
  class AsyncCache_2 : public ::Il2CppObject {
    ...
    class $$c__DisplayClass4_0 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      System::Threading::Tasks::Task_1<TValue>* $get_Item$b__1() {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Threading::Tasks::Task_1<TValue>*>(this, "<get_Item>b__1"));
      }
      ...
      static typename AsyncCache_2<TKey, TValue>::$$c__DisplayClass4_0* New_ctor() {
        return (typename AsyncCache_2<TKey, TValue>::$$c__DisplayClass4_0*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename AsyncCache_2<TKey, TValue>::$$c__DisplayClass4_0*>::get()));
      }
    ...
    static AsyncCache_2<TKey, TValue>* New_ctor(System::Func_2<TKey, System::Threading::Tasks::Task_1<TValue>*>* valueFactory) {
      return (AsyncCache_2<TKey, TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<AsyncCache_2<TKey, TValue>*>::get(), valueFactory));
    }
    // public System.Threading.Tasks.Task`1<TValue> get_Item(TKey key)
    // Offset: 0x127C0DC
    System::Threading::Tasks::Task_1<TValue>* get_Item(TKey key) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Threading::Tasks::Task_1<TValue>*>(this, "get_Item", key));
    }
    // public System.Void RemoveKey(TKey key)
    // Offset: 0x127C1F8
    void RemoveKey(TKey key) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "RemoveKey", key));
    }
    ...
    System::Lazy_1<System::Threading::Tasks::Task_1<TValue>*>* $get_Item$b__4_0(TKey toAdd) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Lazy_1<System::Threading::Tasks::Task_1<TValue>*>*>(this, "<get_Item>b__4_0", toAdd));
    }
  }; // AsyncCache`2
}
