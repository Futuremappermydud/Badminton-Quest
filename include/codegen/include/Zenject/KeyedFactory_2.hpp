...
namespace Zenject {
  ...
  class KeyedFactory_2 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    TBase Create(TKey key) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TBase>(this, "Create", key));
    }
    ...
    static KeyedFactory_2<TBase, TKey>* New_ctor() {
      return (KeyedFactory_2<TBase, TKey>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KeyedFactory_2<TBase, TKey>*>::get()));
    }
