  ...
  class List_1 : public ::Il2CppObject, public System::Collections::Generic::IList_1<T>, public System::Collections::Generic::ICollection_1<T>, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::IEnumerable, public System::Collections::IList, public System::Collections::ICollection, public System::Collections::Generic::IReadOnlyList_1<T>, public System::Collections::Generic::IReadOnlyCollection_1<T> {
    ...
    struct Enumerator : public System::ValueType, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::Collections::Generic::IEnumerator_1<T>, public System::IDisposable, public System::Collections::IEnumerator {
      ...
      static typename List_1<T>::Enumerator* New_ctor(System::Collections::Generic::List_1<T>* list) {
        return (typename List_1<T>::Enumerator*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename List_1<T>::Enumerator>::get(), list));
      }
      // private System.Boolean MoveNextRare()
      // Offset: 0xA29E7C
      bool MoveNextRare() {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(*this, "MoveNextRare"));
      }
    ...
    static int _get__defaultCapacity() {
      return CRASH_UNLESS((il2cpp_utils::GetFieldValue<int>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), "_defaultCapacity")));
    }
    // Autogenerated static field setter
    // Set static field: static private System.Int32 _defaultCapacity
    static void _set__defaultCapacity(int value) {
      CRASH_UNLESS(il2cpp_utils::SetFieldValue(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), "_defaultCapacity", value));
    }
    // private T[] _items
    // Offset: 0x0
    ::Array<T>* items;
    ...
    static ::Array<T>* _get__emptyArray() {
      return CRASH_UNLESS((il2cpp_utils::GetFieldValue<::Array<T>*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), "_emptyArray")));
    }
    // Autogenerated static field setter
    // Set static field: static private readonly T[] _emptyArray
    static void _set__emptyArray(::Array<T>* value) {
      CRASH_UNLESS(il2cpp_utils::SetFieldValue(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), "_emptyArray", value));
    }
    // public System.Void .ctor(System.Int32 capacity)
    // Offset: 0xCF0074
    static List_1<T>* New_ctor(int capacity) {
      return (List_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), capacity));
    }
    ...
    static List_1<T>* New_ctor(System::Collections::Generic::IEnumerable_1<T>* collection) {
      return (List_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), collection));
    }
    // public System.Int32 get_Capacity()
    // Offset: 0xCF0754
    int get_Capacity() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "get_Capacity"));
    }
    // public System.Void set_Capacity(System.Int32 value)
    // Offset: 0xCF0770
    void set_Capacity(int value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_Capacity", value));
    }
    // static private System.Boolean IsCompatibleObject(System.Object value)
    // Offset: 0xCF0A18
    static bool IsCompatibleObject(::Il2CppObject* value) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), "IsCompatibleObject", value));
    }
    ...
    void AddRange(System::Collections::Generic::IEnumerable_1<T>* collection) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "AddRange", collection));
    }
    ...
    System::Collections::ObjectModel::ReadOnlyCollection_1<T>* AsReadOnly() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::ObjectModel::ReadOnlyCollection_1<T>*>(this, "AsReadOnly"));
    }
    ...
    int BinarySearch(int index, int count, T item, System::Collections::Generic::IComparer_1<T>* comparer) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "BinarySearch", index, count, item, comparer));
    }
    // public System.Int32 BinarySearch(T item)
    // Offset: 0xCF1150
    int BinarySearch(T item) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "BinarySearch", item));
    }
    ...
    void CopyTo(int index, ::Array<T>* array, int arrayIndex, int count) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "CopyTo", index, array, arrayIndex, count));
    }
    // private System.Void EnsureCapacity(System.Int32 min)
    // Offset: 0xCF1660
    void EnsureCapacity(int min) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "EnsureCapacity", min));
    }
    // public System.Boolean Exists(System.Predicate`1<T> match)
    // Offset: 0x17B9B4C
    bool Exists(System::Predicate_1<T>* match) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Exists", match));
    }
    // public T Find(System.Predicate`1<T> match)
    // Offset: 0x17B9B80
    T Find(System::Predicate_1<T>* match) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<T>(this, "Find", match));
    }
    // public System.Int32 FindIndex(System.Predicate`1<T> match)
    // Offset: 0xCF1808
    int FindIndex(System::Predicate_1<T>* match) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "FindIndex", match));
    }
    ...
    int FindIndex(int startIndex, int count, System::Predicate_1<T>* match) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "FindIndex", startIndex, count, match));
    }
    // public System.Void ForEach(System.Action`1<T> action)
    // Offset: 0xCF1974
    void ForEach(System::Action_1<T>* action) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "ForEach", action));
    }
    ...
    typename System::Collections::Generic::List_1<T>::Enumerator GetEnumerator() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<typename System::Collections::Generic::List_1<T>::Enumerator>(this, "GetEnumerator"));
    }
    ...
    System::Collections::Generic::List_1<T>* GetRange(int index, int count) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<T>*>(this, "GetRange", index, count));
    }
    ...
    void InsertRange(int index, System::Collections::Generic::IEnumerable_1<T>* collection) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "InsertRange", index, collection));
    }
    // public System.Int32 RemoveAll(System.Predicate`1<T> match)
    // Offset: 0xCF2870
    int RemoveAll(System::Predicate_1<T>* match) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "RemoveAll", match));
    }
    // public System.Void RemoveRange(System.Int32 index, System.Int32 count)
    // Offset: 0xCF2B80
    void RemoveRange(int index, int count) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "RemoveRange", index, count));
    }
    // public System.Void Reverse()
    // Offset: 0xCF2C4C
    void Reverse() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Reverse"));
    }
    // public System.Void Reverse(System.Int32 index, System.Int32 count)
    // Offset: 0xCF2CA4
    void Reverse(int index, int count) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Reverse", index, count));
    }
    // public System.Void Sort()
    // Offset: 0xCF2D4C
    void Sort() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Sort"));
    }
    ...
    void Sort(System::Collections::Generic::IComparer_1<T>* comparer) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Sort", comparer));
    }
    ...
    void Sort(int index, int count, System::Collections::Generic::IComparer_1<T>* comparer) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Sort", index, count, comparer));
    }
    // public System.Void Sort(System.Comparison`1<T> comparison)
    // Offset: 0xCF2EC8
    void Sort(System::Comparison_1<T>* comparison) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Sort", comparison));
    }
    // public T[] ToArray()
    // Offset: 0x17BB154
    ::Array<T>* ToArray() {
    ...
    // Offset: 0xCF2FB0
    static void _cctor() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get(), ".cctor"));
    }
    ...
    static List_1<T>* New_ctor() {
      return (List_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<List_1<T>*>::get()));
    }
    ...
    int System_Collections_IList_Add(::Il2CppObject* item) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "System.Collections.IList.Add", item));
    }
    ...
    bool System_Collections_IList_Contains(::Il2CppObject* item) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "System.Collections.IList.Contains", item));
    }
    ...
    void System_Collections_ICollection_CopyTo(System::Array* array, int arrayIndex) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "System.Collections.ICollection.CopyTo", array, arrayIndex));
    }
    ...
    int System_Collections_IList_IndexOf(::Il2CppObject* item) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "System.Collections.IList.IndexOf", item));
    }
    ...
    void System_Collections_IList_Insert(int index, ::Il2CppObject* item) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "System.Collections.IList.Insert", index, item));
    }
    ...
    void System_Collections_IList_Remove(::Il2CppObject* item) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "System.Collections.IList.Remove", item));
    }
