...
namespace Zenject {
  ...
  class ArgConditionCopyNonLazyBinder : public Zenject::InstantiateCallbackConditionCopyNonLazyBinder {
    ...
    Zenject::InstantiateCallbackConditionCopyNonLazyBinder* WithArguments(T param) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::InstantiateCallbackConditionCopyNonLazyBinder*>(this, "WithArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, param));
    }
    ...
    Zenject::InstantiateCallbackConditionCopyNonLazyBinder* WithArguments(TParam1 param1, TParam2 param2) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::InstantiateCallbackConditionCopyNonLazyBinder*>(this, "WithArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TParam1>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TParam2>::get()}, param1, param2));
    }
