...
namespace UnityEngine::UI {
  ...
  class AspectRatioFitter : public UnityEngine::EventSystems::UIBehaviour, public UnityEngine::UI::ILayoutSelfController, public UnityEngine::UI::ILayoutController {
    public:
