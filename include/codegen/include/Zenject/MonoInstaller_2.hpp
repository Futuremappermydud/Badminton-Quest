...
namespace Zenject {
  // Forward declaring type: MonoInstaller`2<TDerived, TParam1>
...
namespace Zenject {
  ...
  class MonoInstaller_2 : public Zenject::MonoInstallerBase {
    ...
    static TDerived InstallFromResource(Zenject::DiContainer* container, TParam1 p1) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TDerived, TParam1>*>::get(), "InstallFromResource", container, p1));
    }
    ...
    static TDerived InstallFromResource(::Il2CppString* resourcePath, Zenject::DiContainer* container, TParam1 p1) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TDerived>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TDerived, TParam1>*>::get(), "InstallFromResource", resourcePath, container, p1));
    }
    ...
    // Base method: System.Void Object::.ctor()
    static MonoInstaller_2<TDerived, TParam1>* New_ctor() {
      return (MonoInstaller_2<TDerived, TParam1>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MonoInstaller_2<TDerived, TParam1>*>::get()));
    }
