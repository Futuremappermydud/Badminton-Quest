...
namespace System::Collections::Generic {
  ...
  class LinkedListNode_1 : public ::Il2CppObject {
    ...
    static LinkedListNode_1<T>* New_ctor(System::Collections::Generic::LinkedList_1<T>* list, T value) {
      return (LinkedListNode_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LinkedListNode_1<T>*>::get(), list, value));
    }
    // public System.Collections.Generic.LinkedListNode`1<T> get_Next()
    // Offset: 0xCE55D0
    System::Collections::Generic::LinkedListNode_1<T>* get_Next() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::LinkedListNode_1<T>*>(this, "get_Next"));
    }
    // public T get_Value()
    // Offset: 0xCE5604
    T get_Value() {
    ...
    // Offset: 0xCE560C
    void Invalidate() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Invalidate"));
    }
