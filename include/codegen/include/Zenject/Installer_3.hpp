...
namespace Zenject {
  ...
  class Installer_3 : public Zenject::InstallerBase {
    ...
    static void Install(Zenject::DiContainer* container, TParam1 p1, TParam2 p2) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_3<TParam1, TParam2, TDerived>*>::get(), "Install", container, p1, p2));
    }
    ...
    static Installer_3<TParam1, TParam2, TDerived>* New_ctor() {
      return (Installer_3<TParam1, TParam2, TDerived>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_3<TParam1, TParam2, TDerived>*>::get()));
    }
  }; // Zenject.Installer`3
}
