...
namespace UnityEngine::Events {
  ...
  class UnityAction_3 : public System::MulticastDelegate {
    ...
    static UnityAction_3<T0, T1, T2>* New_ctor(::Il2CppObject* object, System::IntPtr method) {
      return (UnityAction_3<T0, T1, T2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityAction_3<T0, T1, T2>*>::get(), object, method));
    }
    ...
    System::IAsyncResult* BeginInvoke(T0 arg0, T1 arg1, T2 arg2, System::AsyncCallback* callback, ::Il2CppObject* object) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::IAsyncResult*>(this, "BeginInvoke", arg0, arg1, arg2, callback, object));
    }
