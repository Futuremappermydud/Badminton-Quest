...
namespace Zenject {
  ...
  class PoolableMemoryPoolProviderBase_1 : public ::Il2CppObject, public Zenject::IProvider {
    ...
    static PoolableMemoryPoolProviderBase_1<TContract>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      return (PoolableMemoryPoolProviderBase_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PoolableMemoryPoolProviderBase_1<TContract>*>::get(), container, poolId));
    }
    // protected System.Guid get_PoolId()
    // Offset: 0x15D86EC
    System::Guid get_PoolId() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Guid>(this, "get_PoolId"));
    }
    // private System.Void set_PoolId(System.Guid value)
    // Offset: 0x15D86F8
    void set_PoolId(System::Guid value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_PoolId", value));
    }
    ...
    void set_Container(Zenject::DiContainer* value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_Container", value));
    }
