...
namespace Zenject {
  ...
  class MethodProviderSimple_1 : public ::Il2CppObject, public Zenject::IProvider {
    ...
    static MethodProviderSimple_1<TReturn>* New_ctor(System::Func_1<TReturn>* method) {
      return (MethodProviderSimple_1<TReturn>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MethodProviderSimple_1<TReturn>*>::get(), method));
    }
