...
namespace System::Reflection {
  ...
  class CustomAttributeData : public ::Il2CppObject {
    ...
    static ::Array<T>* UnboxValues(::Array<::Il2CppObject*>* values) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>("System.Reflection", "CustomAttributeData", "UnboxValues", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, values));
    }
