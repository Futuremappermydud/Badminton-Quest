...
namespace ModestTree {
  ...
  template<typename T>
  class LinqExtensions::$Yield$d__0_1 : public ::Il2CppObject, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::IEnumerable, public System::Collections::Generic::IEnumerator_1<T>, public System::Collections::IEnumerator, public System::IDisposable {
    public:
    ...
    static LinqExtensions::$Yield$d__0_1<T>* New_ctor(int $$1__state) {
      return (LinqExtensions::$Yield$d__0_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<LinqExtensions::$Yield$d__0_1<T>*>::get(), $$1__state));
    }
