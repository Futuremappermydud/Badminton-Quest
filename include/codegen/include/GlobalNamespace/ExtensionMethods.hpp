...
namespace GlobalNamespace {
  ...
  class ExtensionMethods : public ::Il2CppObject {
    ...
    static UnityEngine::Coroutine* StartUniqueCoroutine(UnityEngine::MonoBehaviour* m, System::Func_2<T, System::Collections::IEnumerator*>* func, T value) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<UnityEngine::Coroutine*>("", "ExtensionMethods", "StartUniqueCoroutine", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, m, func, value));
    }
    ...
    static void StopUniqueCoroutine(UnityEngine::MonoBehaviour* m, System::Func_2<T, System::Collections::IEnumerator*>* func) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod("", "ExtensionMethods", "StopUniqueCoroutine", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, m, func));
    }
