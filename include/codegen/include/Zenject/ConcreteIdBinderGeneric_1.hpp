...
namespace Zenject {
  ...
  class ConcreteIdBinderGeneric_1 : public Zenject::ConcreteBinderGeneric_1<TContract> {
    ...
    Zenject::ConcreteBinderGeneric_1<TContract>* WithId(::Il2CppObject* identifier) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<Zenject::ConcreteBinderGeneric_1<TContract>*>(this, "WithId", identifier));
    }
    ...
    static ConcreteIdBinderGeneric_1<TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::BindStatement* bindStatement) {
      return (ConcreteIdBinderGeneric_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ConcreteIdBinderGeneric_1<TContract>*>::get(), bindContainer, bindInfo, bindStatement));
    }
