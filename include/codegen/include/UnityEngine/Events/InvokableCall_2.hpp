...
namespace UnityEngine::Events {
  ...
  class InvokableCall_2 : public UnityEngine::Events::BaseInvokableCall {
    ...
    static InvokableCall_2<T1, T2>* New_ctor(UnityEngine::Events::UnityAction_2<T1, T2>* action) {
      return (InvokableCall_2<T1, T2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InvokableCall_2<T1, T2>*>::get(), action));
    }
    // public System.Void Invoke(T1 args0, T2 args1)
    // Offset: 0x13EC734
    void Invoke(T1 args0, T2 args1) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Invoke", args0, args1));
    }
    ...
    static InvokableCall_2<T1, T2>* New_ctor(::Il2CppObject* target, System::Reflection::MethodInfo* theFunction) {
      return (InvokableCall_2<T1, T2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InvokableCall_2<T1, T2>*>::get(), target, theFunction));
    }
