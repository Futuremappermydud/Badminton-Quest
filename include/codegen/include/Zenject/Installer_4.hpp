...
namespace Zenject {
  ...
  class Installer_4 : public Zenject::InstallerBase {
    ...
    static void Install(Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_4<TParam1, TParam2, TParam3, TDerived>*>::get(), "Install", container, p1, p2, p3));
    }
    ...
    static Installer_4<TParam1, TParam2, TParam3, TDerived>* New_ctor() {
      return (Installer_4<TParam1, TParam2, TParam3, TDerived>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_4<TParam1, TParam2, TParam3, TDerived>*>::get()));
    }
  }; // Zenject.Installer`4
}
