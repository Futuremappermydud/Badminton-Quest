...
namespace TMPro {
  ...
  class FastAction_1 : public ::Il2CppObject {
    ...
    // Offset: 0x13E422C
    void Call(A a) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Call", a));
    }
    ...
    static FastAction_1<A>* New_ctor() {
      return (FastAction_1<A>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FastAction_1<A>*>::get()));
    }
  }; // TMPro.FastAction`1
}
