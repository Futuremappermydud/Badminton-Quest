...
namespace System::Threading {
  ...
  class AsyncLocal_1 : public ::Il2CppObject, public System::Threading::IAsyncLocal {
    ...
    static AsyncLocal_1<T>* New_ctor(System::Action_1<System::Threading::AsyncLocalValueChangedArgs_1<T>>* valueChangedHandler) {
      return (AsyncLocal_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<AsyncLocal_1<T>*>::get(), valueChangedHandler));
    }
    // public T get_Value()
    // Offset: 0x147670C
    T get_Value() {
    ...
    void System_Threading_IAsyncLocal_OnValueChanged(::Il2CppObject* previousValueObj, ::Il2CppObject* currentValueObj, bool contextChanged) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "System.Threading.IAsyncLocal.OnValueChanged", previousValueObj, currentValueObj, contextChanged));
    }
