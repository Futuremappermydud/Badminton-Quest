...
namespace UnityEngine {
  ...
  class Animator : public UnityEngine::Behaviour {
    ...
    static ::Array<T>* ConvertStateMachineBehaviour(::Array<UnityEngine::ScriptableObject*>* rawObjects) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>("UnityEngine", "Animator", "ConvertStateMachineBehaviour", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, rawObjects));
    }
    ...
    ::Array<T>* GetBehaviours() {
      static_assert(std::is_convertible_v<T, UnityEngine::StateMachineBehaviour*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>(this, "GetBehaviours", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
