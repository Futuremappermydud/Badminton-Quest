...
namespace UnityEngine {
  ...
  class ScriptableObject : public UnityEngine::Object {
    ...
    static T CreateInstance() {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine", "ScriptableObject", "CreateInstance", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
