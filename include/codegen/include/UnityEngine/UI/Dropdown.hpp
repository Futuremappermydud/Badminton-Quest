...
namespace UnityEngine::UI {
  ...
  class Dropdown : public UnityEngine::UI::Selectable, public UnityEngine::EventSystems::IPointerClickHandler, public UnityEngine::EventSystems::IEventSystemHandler, public UnityEngine::EventSystems::ISubmitHandler, public UnityEngine::EventSystems::ICancelHandler {
    ...
    static T GetOrAddComponent(UnityEngine::GameObject* go) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine.UI", "Dropdown", "GetOrAddComponent", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, go));
    }
