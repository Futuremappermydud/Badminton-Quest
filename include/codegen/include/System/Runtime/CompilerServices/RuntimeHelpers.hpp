...
namespace System::Runtime::CompilerServices {
  ...
  class RuntimeHelpers : public ::Il2CppObject {
    ...
    static bool IsReferenceOrContainsReferences() {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<bool>("System.Runtime.CompilerServices", "RuntimeHelpers", "IsReferenceOrContainsReferences", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
