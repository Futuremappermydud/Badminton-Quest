...
namespace Unity::Collections::LowLevel::Unsafe {
  ...
  class UnsafeUtility : public ::Il2CppObject {
    ...
    static T ReadArrayElement(void* source, int index) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("Unity.Collections.LowLevel.Unsafe", "UnsafeUtility", "ReadArrayElement", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, source, index));
    }
    ...
    static void WriteArrayElement(void* destination, int index, T value) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod("Unity.Collections.LowLevel.Unsafe", "UnsafeUtility", "WriteArrayElement", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, destination, index, value));
    }
