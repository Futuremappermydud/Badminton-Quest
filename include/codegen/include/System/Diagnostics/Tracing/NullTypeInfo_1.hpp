...
namespace System::Diagnostics::Tracing {
  ...
  class NullTypeInfo_1 : public System::Diagnostics::Tracing::TraceLoggingTypeInfo_1<DataType> {
    ...
    // Base method: System.Void TraceLoggingTypeInfo`1::WriteData(System.Diagnostics.Tracing.TraceLoggingDataCollector collector, DataType value)
    ...
    static NullTypeInfo_1<DataType>* New_ctor() {
      return (NullTypeInfo_1<DataType>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<NullTypeInfo_1<DataType>*>::get()));
    }
