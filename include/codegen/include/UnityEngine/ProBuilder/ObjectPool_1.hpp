...
namespace UnityEngine::ProBuilder {
  ...
  class ObjectPool_1 : public ::Il2CppObject, public System::IDisposable {
    ...
    static ObjectPool_1<T>* New_ctor(int initialSize, int desiredSize, System::Func_1<T>* constructor, System::Action_1<T>* destructor, bool lazyInitialization) {
      return (ObjectPool_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ObjectPool_1<T>*>::get(), initialSize, desiredSize, constructor, destructor, lazyInitialization));
    }
    // public T Get()
    // Offset: 0x1173920
    T Get() {
    ...
    // Offset: 0x1173998
    void Put(T obj) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Put", obj));
    }
    // public System.Void Empty()
    // Offset: 0x1173A24
    void Empty() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Empty"));
    }
