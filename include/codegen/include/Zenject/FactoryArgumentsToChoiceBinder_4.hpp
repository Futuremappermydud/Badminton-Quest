...
namespace Zenject {
  ...
  class FactoryArgumentsToChoiceBinder_4 : public Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract> {
    ...
    Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>* WithFactoryArguments(T param) {
      return CRASH_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, param)));
    }
    ...
    Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>* WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2) {
      return CRASH_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam1>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam2>::get()}, param1, param2)));
    }
    ...
    Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>* WithFactoryArguments(::Array<::Il2CppObject*>* args) {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*>(this, "WithFactoryArguments", args)));
    }
    ...
    Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>* WithFactoryArgumentsExplicit(System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArgs) {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*>(this, "WithFactoryArgumentsExplicit", extraArgs)));
    }
    ...
    static FactoryArgumentsToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      return (FactoryArgumentsToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryArgumentsToChoiceBinder_4<TParam1, TParam2, TParam3, TContract>*>::get(), bindContainer, bindInfo, factoryBindInfo));
    }
