...
namespace Zenject {
  ...
  class KeyedFactory_3 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    TBase Create(TKey key, TParam1 param1) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TBase>(this, "Create", key, param1));
    }
    ...
    static KeyedFactory_3<TBase, TKey, TParam1>* New_ctor() {
      return (KeyedFactory_3<TBase, TKey, TParam1>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KeyedFactory_3<TBase, TKey, TParam1>*>::get()));
    }
