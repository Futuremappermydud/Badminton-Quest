...
namespace UnityEngine {
  ...
  class AttributeHelperEngine : public ::Il2CppObject {
    ...
    static T GetCustomAttributeOfType(System::Type* klass) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine", "AttributeHelperEngine", "GetCustomAttributeOfType", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, klass));
    }
