...
namespace Zenject {
  ...
  class Installer_5 : public Zenject::InstallerBase {
    ...
    static void Install(Zenject::DiContainer* container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>*>::get(), "Install", container, p1, p2, p3, p4));
    }
    ...
    static Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>* New_ctor() {
      return (Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Installer_5<TParam1, TParam2, TParam3, TParam4, TDerived>*>::get()));
    }
  }; // Zenject.Installer`5
}
