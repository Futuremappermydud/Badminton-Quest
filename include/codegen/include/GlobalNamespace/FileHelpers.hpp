...
namespace GlobalNamespace {
  ...
  class FileHelpers : public ::Il2CppObject {
    ...
    static T LoadFromJSONFile(::Il2CppString* filePath, ::Il2CppString* backupFilePath) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("", "FileHelpers", "LoadFromJSONFile", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, filePath, backupFilePath));
    }
