...
namespace Zenject {
  ...
  class InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1 : public ::Il2CppObject {
    ...
    void $OnInstantiated$b__0(Zenject::InjectContext* ctx, ::Il2CppObject* obj) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "<OnInstantiated>b__0", ctx, obj));
    }
    ...
    static InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1<T>* New_ctor() {
      return (InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<InstantiateCallbackConditionCopyNonLazyBinder::$$c__DisplayClass2_0_1<T>*>::get()));
    }
