...
// Including type: Zenject.FactoryToChoiceBinder`2
...
namespace Zenject {
  // Autogenerated type: Zenject.FactoryArgumentsToChoiceBinder`2
  template<typename TParam1, typename TContract>
  class FactoryArgumentsToChoiceBinder_2 : public Zenject::FactoryToChoiceBinder_2<TParam1, TContract> {
    public:
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(T param)
    // Offset: 0x13D7AE4
    template<class T>
    Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* WithFactoryArguments(T param) {
      return CRASH_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, param)));
    }
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2)
    // Offset: 0x13D7A88
    ...
    Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2) {
      return CRASH_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam1>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam2>::get()}, param1, param2)));
    }
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2, TFactoryParam3 param3)
    // Offset: 0x13D7A28
    ...
    Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2, TFactoryParam3 param3) {
      return CRASH_UNLESS((il2cpp_utils::RunGenericMethod<Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(this, "WithFactoryArguments", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam1>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam2>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TFactoryParam3>::get()}, param1, param2, param3)));
    }
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2, TFactoryParam3 param3, TFactoryParam4 param4)
    // Offset: 0x13D79C4
    ...
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2, TFactoryParam3 param3, TFactoryParam4 param4, TFactoryParam5 param5)
    // Offset: 0x13D795C
    ...
    // public Zenject.FactoryToChoiceBinder`2<TParam1,TContract> WithFactoryArguments(TFactoryParam1 param1, TFactoryParam2 param2, TFactoryParam3 param3, TFactoryParam4 param4, TFactoryParam5 param5, TFactoryParam6 param6)
    // Offset: 0x13D78F0
    ...
    Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* WithFactoryArguments(::Array<::Il2CppObject*>* args) {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(this, "WithFactoryArguments", args)));
    }
    ...
    Zenject::FactoryToChoiceBinder_2<TParam1, TContract>* WithFactoryArgumentsExplicit(System::Collections::Generic::IEnumerable_1<Zenject::TypeValuePair>* extraArgs) {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<Zenject::FactoryToChoiceBinder_2<TParam1, TContract>*>(this, "WithFactoryArgumentsExplicit", extraArgs)));
    }
    ...
    // Offset: 0x117CFA8
    // Implemented from: Zenject.FactoryToChoiceBinder`2
    ...
    static FactoryArgumentsToChoiceBinder_2<TParam1, TContract>* New_ctor(Zenject::DiContainer* bindContainer, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      return (FactoryArgumentsToChoiceBinder_2<TParam1, TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryArgumentsToChoiceBinder_2<TParam1, TContract>*>::get(), bindContainer, bindInfo, factoryBindInfo));
    }
  }; // Zenject.FactoryArgumentsToChoiceBinder`2
}
