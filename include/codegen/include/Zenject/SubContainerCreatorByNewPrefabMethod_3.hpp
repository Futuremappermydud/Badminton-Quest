...
namespace Zenject {
  ...
  class SubContainerCreatorByNewPrefabMethod_3 : public Zenject::SubContainerCreatorByNewPrefabDynamicContext {
    ...
    // Autogenerated type: Zenject.SubContainerCreatorByNewPrefabMethod`3/<>c__DisplayClass2_0
    class $$c__DisplayClass2_0 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>::$$c__DisplayClass2_0* New_ctor() {
        return (typename SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>::$$c__DisplayClass2_0*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>::$$c__DisplayClass2_0*>::get()));
      }
    }; // Zenject.SubContainerCreatorByNewPrefabMethod`3/<>c__DisplayClass2_0
    ...
    static SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>* New_ctor(Zenject::DiContainer* container, Zenject::IPrefabProvider* prefabProvider, Zenject::GameObjectCreationParameters* gameObjectBindInfo, System::Action_4<Zenject::DiContainer*, TParam1, TParam2, TParam3>* installerMethod) {
      return (SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<SubContainerCreatorByNewPrefabMethod_3<TParam1, TParam2, TParam3>*>::get(), container, prefabProvider, gameObjectBindInfo, installerMethod));
    }
