...
namespace UnityEngine::ProBuilder {
  ...
  class InternalUtility : public ::Il2CppObject {
    ...
    static ::Array<T>* GetComponents(System::Collections::Generic::IEnumerable_1<UnityEngine::GameObject*>* gameObjects) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>("UnityEngine.ProBuilder", "InternalUtility", "GetComponents", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, gameObjects));
    }
    ...
    static ::Array<T>* GetComponents(UnityEngine::GameObject* go) {
      static_assert(std::is_convertible_v<T, UnityEngine::Component*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>("UnityEngine.ProBuilder", "InternalUtility", "GetComponents", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, go));
    }
    ...
    static ::Array<T>* GetComponents(System::Collections::Generic::IEnumerable_1<UnityEngine::Transform*>* transforms) {
      static_assert(std::is_convertible_v<T, UnityEngine::Component*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<::Array<T>*>("UnityEngine.ProBuilder", "InternalUtility", "GetComponents", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, transforms));
    }
    ...
    static T NextEnumValue(T current) {
      static_assert(std::is_convertible_v<T, System::IConvertible*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine.ProBuilder", "InternalUtility", "NextEnumValue", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, current));
    }
