  ...
  class Message_1 : public Oculus::Platform::Message {
    ...
    class Callback : public System::MulticastDelegate, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename Message_1<T>::Callback* New_ctor(::Il2CppObject* object, System::IntPtr method) {
        return (typename Message_1<T>::Callback*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename Message_1<T>::Callback*>::get(), object, method));
      }
      // public System.Void Invoke(Oculus.Platform.Message`1<T> message)
      // Offset: 0x1281010
      void Invoke(Oculus::Platform::Message_1<T>* message) {
        CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Invoke", message));
      }
      ...
      System::IAsyncResult* BeginInvoke(Oculus::Platform::Message_1<T>* message, System::AsyncCallback* callback, ::Il2CppObject* object) {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<System::IAsyncResult*>(this, "BeginInvoke", message, callback, object));
      }
    ...
    // Offset: 0x12818DC
    T get_Data() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<T>(this, "get_Data"));
    }
    // protected T GetDataFromMessage(System.IntPtr c_message)
    // Offset: 0xFFFFFFFF
    T GetDataFromMessage(System::IntPtr c_message) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<T>(this, "GetDataFromMessage", c_message));
    }
    ...
    static Message_1<T>* New_ctor(System::IntPtr c_message) {
      return (Message_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Message_1<T>*>::get(), c_message));
    }
