...
namespace UnityEngine::ProBuilder {
  ...
  struct SimpleTuple_2 : public System::ValueType {
    ...
    SimpleTuple_2(T1 m_Item1_ = {}, T2 m_Item2_ = {}) : m_Item1{m_Item1_}, m_Item2{m_Item2_} {}
    // public T1 get_item1()
    // Offset: 0xA3EB54
    T1 get_item1() {
    ...
    void set_item1(T1 value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(*this, "set_item1", value));
    }
    // public T2 get_item2()
    // Offset: 0xA3EB64
    T2 get_item2() {
    ...
    void set_item2(T2 value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(*this, "set_item2", value));
    }
    // public System.Void .ctor(T1 item1, T2 item2)
    // Offset: 0xA3EB74
    static SimpleTuple_2<T1, T2>* New_ctor(T1 item1, T2 item2) {
      return (SimpleTuple_2<T1, T2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<SimpleTuple_2<T1, T2>>::get(), item1, item2));
    }
