...
namespace UnityEngine {
  ...
  class AndroidJavaObject : public ::Il2CppObject, public System::IDisposable {
    ...
    void Call(::Il2CppString* methodName, ::Array<T>* args) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "Call", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, methodName, args));
    }
    ...
    void CallStatic(::Il2CppString* methodName, ::Array<T>* args) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "CallStatic", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, methodName, args));
    }
    ...
    FieldType Get(::Il2CppString* fieldName) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<FieldType>(this, "Get", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName));
    }
    // public System.Void Set(System.String fieldName, FieldType val)
    // Offset: 0xC47884
    template<class FieldType>
    void Set(::Il2CppString* fieldName, FieldType val) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "Set", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName, val));
    }
    // public FieldType GetStatic(System.String fieldName)
    // Offset: 0x14C7088
    template<class FieldType>
    FieldType GetStatic(::Il2CppString* fieldName) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<FieldType>(this, "GetStatic", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName));
    }
    // public System.Void SetStatic(System.String fieldName, FieldType val)
    // Offset: 0xC478A4
    template<class FieldType>
    void SetStatic(::Il2CppString* fieldName, FieldType val) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "SetStatic", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName, val));
    }
    ...
    // Offset: 0x14C88BC
    // ABORTED: conflicts with another method. ReturnType Call(::Il2CppString* methodName, ::Array<T>* args)
    // public ReturnType Call(System.String methodName, System.Object[] args)
    // Offset: 0x14C87FC
    // ABORTED: conflicts with another method. ReturnType Call(::Il2CppString* methodName, ::Array<::Il2CppObject*>* args)
    // public ReturnType CallStatic(System.String methodName, T[] args)
    // Offset: 0x14C8A1C
    // ABORTED: conflicts with another method. ReturnType CallStatic(::Il2CppString* methodName, ::Array<T>* args)
    // public ReturnType CallStatic(System.String methodName, System.Object[] args)
    // Offset: 0x14C89FC
    // ABORTED: conflicts with another method. ReturnType CallStatic(::Il2CppString* methodName, ::Array<::Il2CppObject*>* args)
    ...
    // Offset: 0x14C8B1C
    // ABORTED: conflicts with another method. ReturnType _Call(::Il2CppString* methodName, ::Array<::Il2CppObject*>* args)
    // protected FieldType _Get(System.String fieldName)
    // Offset: 0x14C70A8
    template<class FieldType>
    FieldType _Get(::Il2CppString* fieldName) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<FieldType>(this, "_Get", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName));
    }
    // protected System.Void _Set(System.String fieldName, FieldType val)
    // Offset: 0xC478C4
    template<class FieldType>
    void _Set(::Il2CppString* fieldName, FieldType val) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "_Set", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName, val));
    }
    ...
    // Offset: 0x14D1090
    // ABORTED: conflicts with another method. ReturnType _CallStatic(::Il2CppString* methodName, ::Array<::Il2CppObject*>* args)
    // protected FieldType _GetStatic(System.String fieldName)
    // Offset: 0x14C798C
    template<class FieldType>
    FieldType _GetStatic(::Il2CppString* fieldName) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<FieldType>(this, "_GetStatic", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName));
    }
    ...
    void _SetStatic(::Il2CppString* fieldName, FieldType val) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "_SetStatic", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FieldType>::get()}, fieldName, val));
    }
