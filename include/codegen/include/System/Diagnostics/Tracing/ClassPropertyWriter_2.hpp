  ...
  class ClassPropertyWriter_2 : public System::Diagnostics::Tracing::PropertyAccessor_1<ContainerType> {
    ...
    class Getter : public System::MulticastDelegate, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      static typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter* New_ctor(::Il2CppObject* object, System::IntPtr method) {
        return (typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename ClassPropertyWriter_2<ValueType, ContainerType>::Getter*>::get(), object, method));
      }
      // public ValueType Invoke(ContainerType container)
      // Offset: 0x1604CE0
      ValueType Invoke(ContainerType container) {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<ValueType>(this, "Invoke", container));
      }
      ...
      System::IAsyncResult* BeginInvoke(ContainerType container, System::AsyncCallback* callback, ::Il2CppObject* object) {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<System::IAsyncResult*>(this, "BeginInvoke", container, callback, object));
      }
      // public ValueType EndInvoke(System.IAsyncResult result)
      // Offset: 0x1604FF4
      ValueType EndInvoke(System::IAsyncResult* result) {
        return CRASH_UNLESS(il2cpp_utils::RunMethod<ValueType>(this, "EndInvoke", result));
      }
    ...
    static ClassPropertyWriter_2<ContainerType, ValueType>* New_ctor(System::Diagnostics::Tracing::PropertyAnalysis* property) {
      return (ClassPropertyWriter_2<ContainerType, ValueType>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ClassPropertyWriter_2<ContainerType, ValueType>*>::get(), property));
    }
    ...
    void Write(System::Diagnostics::Tracing::TraceLoggingDataCollector* collector, ContainerType& container) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Write", collector, container));
    }
    ...
    ::Il2CppObject* GetData(ContainerType container) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppObject*>(this, "GetData", container));
    }
