...
namespace Zenject {
  ...
  class FactoryProviderWrapper_1 : public ::Il2CppObject, public Zenject::IFactory_1<TContract>, public Zenject::IFactory {
    ...
    static FactoryProviderWrapper_1<TContract>* New_ctor(Zenject::IProvider* provider, Zenject::InjectContext* injectContext) {
      return (FactoryProviderWrapper_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryProviderWrapper_1<TContract>*>::get(), provider, injectContext));
    }
    ...
    TContract Create() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TContract>(this, "Create"));
    }
