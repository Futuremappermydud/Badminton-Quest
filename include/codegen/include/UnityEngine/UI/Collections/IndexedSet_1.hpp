...
namespace UnityEngine::UI::Collections {
  ...
  template<typename T>
  class IndexedSet_1 : public ::Il2CppObject, public System::Collections::Generic::IList_1<T>, public System::Collections::Generic::ICollection_1<T>, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::IEnumerable {
    public:
    ...
    static IndexedSet_1<T>* New_ctor() {
      return (IndexedSet_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IndexedSet_1<T>*>::get()));
    }
