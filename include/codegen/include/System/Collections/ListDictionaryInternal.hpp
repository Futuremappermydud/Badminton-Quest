...
namespace System::Collections {
  ...
  class ListDictionaryInternal : public ::Il2CppObject, public System::Collections::IDictionary, public System::Collections::ICollection, public System::Collections::IEnumerable {
    public:
