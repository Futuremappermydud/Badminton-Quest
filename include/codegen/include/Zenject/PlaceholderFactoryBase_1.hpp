...
namespace Zenject {
  ...
  class PlaceholderFactoryBase_1 : public ::Il2CppObject, public Zenject::IPlaceholderFactory, public Zenject::IValidatable {
    ...
    void Construct(Zenject::IProvider* provider, Zenject::InjectContext* injectContext) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Construct", provider, injectContext));
    }
    ...
    TValue CreateInternal(System::Collections::Generic::List_1<Zenject::TypeValuePair>* extraArgs) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TValue>(this, "CreateInternal", extraArgs));
    }
    ...
    static PlaceholderFactoryBase_1<TValue>* New_ctor() {
      return (PlaceholderFactoryBase_1<TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PlaceholderFactoryBase_1<TValue>*>::get()));
    }
