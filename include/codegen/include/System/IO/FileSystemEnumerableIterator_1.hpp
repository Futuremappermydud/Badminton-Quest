...
namespace System::IO {
  ...
  class FileSystemEnumerableIterator_1 : public System::IO::Iterator_1<TSource> {
    ...
    static FileSystemEnumerableIterator_1<TSource>* New_ctor(::Il2CppString* path, ::Il2CppString* originalUserPath, ::Il2CppString* searchPattern, System::IO::SearchOption searchOption, System::IO::SearchResultHandler_1<TSource>* resultHandler, bool checkHost) {
      return (FileSystemEnumerableIterator_1<TSource>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FileSystemEnumerableIterator_1<TSource>*>::get(), path, originalUserPath, searchPattern, searchOption, resultHandler, checkHost));
    }
    // private System.Void CommonInit()
    // Offset: 0x1266EDC
    void CommonInit() {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "CommonInit"));
    }
    ...
    static FileSystemEnumerableIterator_1<TSource>* New_ctor(::Il2CppString* fullPath, ::Il2CppString* normalizedSearchPath, ::Il2CppString* searchCriteria, ::Il2CppString* userPath, System::IO::SearchOption searchOption, System::IO::SearchResultHandler_1<TSource>* resultHandler, bool checkHost) {
      return (FileSystemEnumerableIterator_1<TSource>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FileSystemEnumerableIterator_1<TSource>*>::get(), fullPath, normalizedSearchPath, searchCriteria, userPath, searchOption, resultHandler, checkHost));
    }
    ...
    System::IO::SearchResult* CreateSearchResult(System::IO::Directory::SearchData* localSearchData, Microsoft::Win32::Win32Native::WIN32_FIND_DATA* findData) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::IO::SearchResult*>(this, "CreateSearchResult", localSearchData, findData));
    }
    // private System.Void HandleError(System.Int32 hr, System.String path)
    // Offset: 0x1267AC8
    void HandleError(int hr, ::Il2CppString* path) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "HandleError", hr, path));
    }
    ...
    void AddSearchableDirsToStack(System::IO::Directory::SearchData* localSearchData) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "AddSearchableDirsToStack", localSearchData));
    }
    // System.Void DoDemand(System.String fullPathToDemand)
    // Offset: 0x1267E6C
    void DoDemand(::Il2CppString* fullPathToDemand) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "DoDemand", fullPathToDemand));
    }
    ...
    static ::Il2CppString* NormalizeSearchPattern(::Il2CppString* searchPattern) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FileSystemEnumerableIterator_1<TSource>*>::get(), "NormalizeSearchPattern", searchPattern));
    }
    ...
    static ::Il2CppString* GetNormalizedSearchCriteria(::Il2CppString* fullSearchString, ::Il2CppString* fullPathMod) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FileSystemEnumerableIterator_1<TSource>*>::get(), "GetNormalizedSearchCriteria", fullSearchString, fullPathMod));
    }
    ...
    static ::Il2CppString* GetFullSearchString(::Il2CppString* fullPath, ::Il2CppString* searchPattern) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FileSystemEnumerableIterator_1<TSource>*>::get(), "GetFullSearchString", fullPath, searchPattern));
    }
