...
namespace UnityEngine::Playables {
  ...
  struct PlayableGraph : public System::ValueType {
    ...
    bool Connect(U source, int sourceOutputPort, V destination, int destinationInputPort) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<bool>(*this, "Connect", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<V>::get()}, source, sourceOutputPort, destination, destinationInputPort));
    }
