...
namespace System::Linq {
  ...
  class IOrderedEnumerable_1 : public System::Collections::Generic::IEnumerable_1<TElement>, public System::Collections::IEnumerable {
    public:
    ...
    System::Linq::IOrderedEnumerable_1<TElement>* System_Linq_IOrderedEnumerable_1_CreateOrderedEnumerable(System::Func_2<TElement, TKey>* keySelector, System::Collections::Generic::IComparer_1<TKey>* comparer, bool descending) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<System::Linq::IOrderedEnumerable_1<TElement>*>(this, "CreateOrderedEnumerable", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TKey>::get()}, keySelector, comparer, descending));
    }
