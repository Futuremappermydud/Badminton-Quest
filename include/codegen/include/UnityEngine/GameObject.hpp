...
namespace UnityEngine {
  ...
  class GameObject : public UnityEngine::Object {
    ...
    T GetComponentInChildren(bool includeInactive) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>(this, "GetComponentInChildren", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, includeInactive));
    }
    ...
    void GetComponentsInChildren(bool includeInactive, System::Collections::Generic::List_1<T>* results) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod(this, "GetComponentsInChildren", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, includeInactive, results));
    }
    ...
    T AddComponent() {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>(this, "AddComponent", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
