...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_5 : public Zenject::PoolableMemoryPoolProviderBase_1<TContract>, public Zenject::IValidatable {
    ...
    static PoolableMemoryPoolProvider_5<TContract, TParam1, TParam2, TParam3, TMemoryPool>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      return (PoolableMemoryPoolProvider_5<TContract, TParam1, TParam2, TParam3, TMemoryPool>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PoolableMemoryPoolProvider_5<TContract, TParam1, TParam2, TParam3, TMemoryPool>*>::get(), container, poolId));
    }
