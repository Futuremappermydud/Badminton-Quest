...
namespace Zenject {
  ...
  class KeyedFactory_5 : public Zenject::KeyedFactoryBase_2<TBase, TKey> {
    ...
    TBase Create(TKey key, TParam1 param1, TParam2 param2, TParam3 param3) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TBase>(this, "Create", key, param1, param2, param3));
    }
    ...
    static KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>* New_ctor() {
      return (KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KeyedFactory_5<TBase, TKey, TParam1, TParam2, TParam3>*>::get()));
    }
