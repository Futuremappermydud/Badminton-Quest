...
namespace GlobalNamespace {
  ...
  class SteamVR_Events::Event_1 : public UnityEngine::Events::UnityEvent_1<T> {
    ...
    // Offset: 0x1284380
    void Send(T arg0) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "Send", arg0));
    }
    ...
    static SteamVR_Events::Event_1<T>* New_ctor() {
      return (SteamVR_Events::Event_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<SteamVR_Events::Event_1<T>*>::get()));
    }
