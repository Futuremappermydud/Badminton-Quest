...
namespace UnityEngine::UI {
  ...
  class ContentSizeFitter : public UnityEngine::EventSystems::UIBehaviour, public UnityEngine::UI::ILayoutSelfController, public UnityEngine::UI::ILayoutController {
    public:
