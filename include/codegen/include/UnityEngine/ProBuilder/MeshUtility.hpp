...
namespace UnityEngine::ProBuilder {
  ...
  class MeshUtility : public ::Il2CppObject {
    ...
    static T GetMeshChannel(UnityEngine::GameObject* gameObject, System::Func_2<UnityEngine::Mesh*, T>* attributeGetter) {
      static_assert(std::is_convertible_v<T, System::Collections::IList*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine.ProBuilder", "MeshUtility", "GetMeshChannel", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, gameObject, attributeGetter));
    }
