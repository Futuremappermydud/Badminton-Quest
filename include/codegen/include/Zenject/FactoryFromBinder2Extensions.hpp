...
namespace Zenject {
  ...
  class FactoryFromBinder2Extensions : public ::Il2CppObject {
    ...
    static Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder) {
      static_assert(std::is_convertible_v<TContract, Zenject::IPoolable_3<TParam1, TParam2, Zenject::IMemoryPool*>*>);
    ...
    static Zenject::ArgConditionCopyNonLazyBinder* FromMonoPoolableMemoryPool(Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder) {
      static_assert(std::is_convertible_v<TContract, UnityEngine::Component*> && std::is_convertible_v<TContract, Zenject::IPoolable_3<TParam1, TParam2, Zenject::IMemoryPool*>*>);
    ...
    // static public Zenject.ArgConditionCopyNonLazyBinder FromPoolableMemoryPool(Zenject.FactoryFromBinder`3<TParam1,TParam2,TContract> fromBinder)
    // Offset: 0x13D1D58
    // ABORTED: conflicts with another method. static Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder)
    // static public Zenject.ArgConditionCopyNonLazyBinder FromPoolableMemoryPool(Zenject.FactoryFromBinder`3<TParam1,TParam2,TContract> fromBinder, System.Action`1<Zenject.MemoryPoolInitialSizeMaxSizeBinder`1<TContract>> poolBindGenerator)
    // Offset: 0x13D1F04
    // ABORTED: conflicts with another method. static Zenject::ArgConditionCopyNonLazyBinder* FromPoolableMemoryPool(Zenject::FactoryFromBinder_3<TParam1, TParam2, TContract>* fromBinder, System::Action_1<Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>* poolBindGenerator)
