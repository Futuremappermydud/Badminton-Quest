...
namespace UnityEngine::Timeline {
  ...
  class TrackAsset : public UnityEngine::Playables::PlayableAsset, public UnityEngine::ISerializationCallbackReceiver, public UnityEngine::Timeline::IPropertyPreview, public UnityEngine::Timeline::ICurvesOwner {
    ...
    UnityEngine::Timeline::TimelineClip* CreateClip() {
      static_assert(std::is_convertible_v<T, UnityEngine::ScriptableObject*> && std::is_convertible_v<T, UnityEngine::Playables::IPlayableAsset*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<UnityEngine::Timeline::TimelineClip*>(this, "CreateClip", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
    }
    ...
    T CreateMarker(double time) {
      static_assert(std::is_convertible_v<T, UnityEngine::ScriptableObject*> && std::is_convertible_v<T, UnityEngine::Timeline::IMarker*>);
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>(this, "CreateMarker", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, time));
    }
