...
namespace Zenject {
  ...
  class IFactoryProviderBase_1 : public ::Il2CppObject, public Zenject::IProvider {
    ...
    static IFactoryProviderBase_1<TContract>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      return (IFactoryProviderBase_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IFactoryProviderBase_1<TContract>*>::get(), container, factoryId));
    }
    // protected System.Guid get_FactoryId()
    // Offset: 0x13AA4E4
    System::Guid get_FactoryId() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Guid>(this, "get_FactoryId"));
    }
    // private System.Void set_FactoryId(System.Guid value)
    // Offset: 0x13AA4F0
    void set_FactoryId(System::Guid value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_FactoryId", value));
    }
