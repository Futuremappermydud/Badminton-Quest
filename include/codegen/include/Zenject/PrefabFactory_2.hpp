...
namespace Zenject {
  ...
  class PrefabFactory_2 : public ::Il2CppObject, public Zenject::IFactory_3<UnityEngine::Object*, P1, T>, public Zenject::IFactory {
    public:
    ...
    T Create(UnityEngine::Object* prefab, P1 param) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<T>(this, "Create", prefab, param));
    }
    ...
    static PrefabFactory_2<P1, T>* New_ctor() {
      return (PrefabFactory_2<P1, T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PrefabFactory_2<P1, T>*>::get()));
    }
