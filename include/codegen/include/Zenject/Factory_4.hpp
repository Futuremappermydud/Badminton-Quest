...
namespace Zenject {
  ...
  class Factory_4 : public Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue> {
    ...
    static Factory_4<TParam1, TParam2, TParam3, TValue>* New_ctor() {
      return (Factory_4<TParam1, TParam2, TParam3, TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Factory_4<TParam1, TParam2, TParam3, TValue>*>::get()));
    }
  }; // Zenject.Factory`4
}
