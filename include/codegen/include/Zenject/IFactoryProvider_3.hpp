...
namespace Zenject {
  ...
  class IFactoryProvider_3 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_3<TContract, TParam1, TParam2>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      return (IFactoryProvider_3<TContract, TParam1, TParam2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IFactoryProvider_3<TContract, TParam1, TParam2>*>::get(), container, factoryId));
    }
