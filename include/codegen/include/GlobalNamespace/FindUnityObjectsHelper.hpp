...
namespace GlobalNamespace {
  ...
  class FindUnityObjectsHelper : public ::Il2CppObject {
    ...
    static System::Collections::Generic::List_1<T>* GetComponentsInGameObjects(System::Collections::Generic::IReadOnlyList_1<UnityEngine::GameObject*>* gameObjects) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<System::Collections::Generic::List_1<T>*>("", "FindUnityObjectsHelper", "GetComponentsInGameObjects", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, gameObjects));
    }
