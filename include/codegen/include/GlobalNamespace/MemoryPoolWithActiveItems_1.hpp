...
namespace GlobalNamespace {
  ...
  class MemoryPoolWithActiveItems_1 : public Zenject::MonoMemoryPool_1<TValue> {
    ...
    System::Collections::Generic::HashSet_1<TValue>* get_activeItems() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::HashSet_1<TValue>*>(this, "get_activeItems"));
    }
    ...
    static MemoryPoolWithActiveItems_1<TValue>* New_ctor() {
      return (MemoryPoolWithActiveItems_1<TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<MemoryPoolWithActiveItems_1<TValue>*>::get()));
    }
