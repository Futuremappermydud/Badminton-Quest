...
namespace System::Linq {
  ...
  class Set_1 : public ::Il2CppObject {
    ...
    static Set_1<TElement>* New_ctor(System::Collections::Generic::IEqualityComparer_1<TElement>* comparer) {
      return (Set_1<TElement>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Set_1<TElement>*>::get(), comparer));
    }
    // public System.Boolean Add(TElement value)
    // Offset: 0x12C6DB8
    bool Add(TElement value) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Add", value));
    }
    // private System.Boolean Find(TElement value, System.Boolean add)
    // Offset: 0x12C6DF0
    bool Find(TElement value, bool add) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Find", value, add));
    }
    ...
    int InternalGetHashCode(TElement value) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "InternalGetHashCode", value));
    }
  }; // System.Linq.Set`1
}
