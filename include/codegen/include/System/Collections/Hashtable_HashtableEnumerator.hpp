...
namespace System::Collections {
  ...
  class Hashtable::HashtableEnumerator : public ::Il2CppObject, public System::Collections::IDictionaryEnumerator, public System::Collections::IEnumerator, public System::ICloneable {
    public:
