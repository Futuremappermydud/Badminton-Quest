...
namespace NUnit::Framework::Constraints {
  ...
  class NUnitEqualityComparer : public ::Il2CppObject {
    ...
    static void CheckGameObjectReference(T& value) {
      CRASH_UNLESS(il2cpp_utils::RunGenericMethod("NUnit.Framework.Constraints", "NUnitEqualityComparer", "CheckGameObjectReference", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, value));
    }
