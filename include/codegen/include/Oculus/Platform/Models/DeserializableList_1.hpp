...
namespace Oculus::Platform::Models {
  ...
  template<typename T>
  class DeserializableList_1 : public ::Il2CppObject, public System::Collections::Generic::IList_1<T>, public System::Collections::Generic::ICollection_1<T>, public System::Collections::Generic::IEnumerable_1<T>, public System::Collections::IEnumerable {
    public:
    ...
    System::Collections::IEnumerator* GetEnumerator1() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::IEnumerator*>(this, "GetEnumerator1"));
    }
    // public System.Collections.Generic.List`1<T> get_Data()
    // Offset: 0x1281C04
    System::Collections::Generic::List_1<T>* get_Data() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<System::Collections::Generic::List_1<T>*>(this, "get_Data"));
    }
    // public System.Boolean get_HasNextPage()
    // Offset: 0x1281C0C
    bool get_HasNextPage() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "get_HasNextPage"));
    }
    // public System.Boolean get_HasPreviousPage()
    // Offset: 0x1281C48
    bool get_HasPreviousPage() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "get_HasPreviousPage"));
    }
    // public System.String get_NextUrl()
    // Offset: 0x1281C84
    ::Il2CppString* get_NextUrl() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "get_NextUrl"));
    }
    // public System.String get_PreviousUrl()
    // Offset: 0x1281C8C
    ::Il2CppString* get_PreviousUrl() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<::Il2CppString*>(this, "get_PreviousUrl"));
    }
    ...
    int IndexOf(T obj) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<int>(this, "IndexOf", obj));
    }
    ...
    static DeserializableList_1<T>* New_ctor() {
      return (DeserializableList_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<DeserializableList_1<T>*>::get()));
    }
