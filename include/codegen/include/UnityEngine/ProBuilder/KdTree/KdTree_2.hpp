...
namespace UnityEngine::ProBuilder::KdTree {
  ...
  template<typename TKey, typename TValue>
  class KdTree_2 : public ::Il2CppObject, public System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>, public System::Collections::IEnumerable {
    public:
    ...
    class $$c__DisplayClass33_0 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType {
      ...
      void $GetEnumerator$b__0(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* node) {
        CRASH_UNLESS(il2cpp_utils::RunMethod(this, "<GetEnumerator>b__0", node));
      }
      ...
      void $GetEnumerator$b__1(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* node) {
        CRASH_UNLESS(il2cpp_utils::RunMethod(this, "<GetEnumerator>b__1", node));
      }
      ...
      static typename KdTree_2<TKey, TValue>::$$c__DisplayClass33_0* New_ctor() {
        return (typename KdTree_2<TKey, TValue>::$$c__DisplayClass33_0*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename KdTree_2<TKey, TValue>::$$c__DisplayClass33_0*>::get()));
      }
    ...
    class $GetEnumerator$d__33 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::Collections::Generic::IEnumerator_1<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>, public System::Collections::IEnumerator, public System::IDisposable {
      public:
      using declaring_type = KdTree_2<TKey, TValue>*;
      ...
      static typename KdTree_2<TKey, TValue>::$GetEnumerator$d__33* New_ctor(int $$1__state) {
        return (typename KdTree_2<TKey, TValue>::$GetEnumerator$d__33*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename KdTree_2<TKey, TValue>::$GetEnumerator$d__33*>::get(), $$1__state));
      }
      ...
      UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* System_Collections_Generic_IEnumerator_1_get_Current() {
        return CRASH_UNLESS((il2cpp_utils::RunMethod<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>(this, "System.Collections.Generic.IEnumerator<UnityEngine.ProBuilder.KdTree.KdTreeNode<TKey,TValue>>.get_Current")));
      }
    ...
    static KdTree_2<TKey, TValue>* New_ctor(int dimensions, UnityEngine::ProBuilder::KdTree::ITypeMath_1<TKey>* typeMath) {
      return (KdTree_2<TKey, TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KdTree_2<TKey, TValue>*>::get(), dimensions, typeMath));
    }
    ...
    static KdTree_2<TKey, TValue>* New_ctor(int dimensions, UnityEngine::ProBuilder::KdTree::ITypeMath_1<TKey>* typeMath, UnityEngine::ProBuilder::KdTree::AddDuplicateBehavior addDuplicateBehavior) {
      return (KdTree_2<TKey, TValue>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<KdTree_2<TKey, TValue>*>::get(), dimensions, typeMath, addDuplicateBehavior));
    }
    ...
    UnityEngine::ProBuilder::KdTree::AddDuplicateBehavior get_AddDuplicateBehavior() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<UnityEngine::ProBuilder::KdTree::AddDuplicateBehavior>(this, "get_AddDuplicateBehavior"));
    }
    ...
    void set_AddDuplicateBehavior(UnityEngine::ProBuilder::KdTree::AddDuplicateBehavior value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_AddDuplicateBehavior", value));
    }
    // public System.Boolean Add(TKey[] point, TValue value)
    // Offset: 0x117010C
    bool Add(::Array<TKey>* point, TValue value) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<bool>(this, "Add", point, value));
    }
    ...
    void AddNearestNeighbours(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* node, ::Array<TKey>* target, UnityEngine::ProBuilder::KdTree::HyperRect_1<TKey> rect, int depth, UnityEngine::ProBuilder::KdTree::NearestNeighbourList_2<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*, TKey>* nearestNeighbours, TKey maxSearchRadiusSquared) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "AddNearestNeighbours", node, target, rect, depth, nearestNeighbours, maxSearchRadiusSquared));
    }
    ...
    ::Array<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>* RadialSearch(::Array<TKey>* center, TKey radius, int count) {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<::Array<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>*>(this, "RadialSearch", center, radius, count)));
    }
    ...
    void set_Count(int value) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "set_Count", value));
    }
    ...
    void AddNodeToStringBuilder(UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>* node, System::Text::StringBuilder* sb, int depth) {
      CRASH_UNLESS(il2cpp_utils::RunMethod(this, "AddNodeToStringBuilder", node, sb, depth));
    }
    ...
    System::Collections::Generic::IEnumerator_1<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>* GetEnumerator() {
      return CRASH_UNLESS((il2cpp_utils::RunMethod<System::Collections::Generic::IEnumerator_1<UnityEngine::ProBuilder::KdTree::KdTreeNode_2<TKey, TValue>*>*>(this, "GetEnumerator")));
    }
