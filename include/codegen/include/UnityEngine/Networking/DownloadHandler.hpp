...
namespace UnityEngine::Networking {
  ...
  class DownloadHandler : public ::Il2CppObject, public System::IDisposable {
    ...
    static T GetCheckedDownloader(UnityEngine::Networking::UnityWebRequest* www) {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<T>("UnityEngine.Networking", "DownloadHandler", "GetCheckedDownloader", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, www));
    }
