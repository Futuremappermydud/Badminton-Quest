...
namespace System::Collections::Generic {
  ...
  class CollectionExtensions : public ::Il2CppObject {
    ...
    static TValue GetValueOrDefault(System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>* dictionary, TKey key) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<TValue>("System.Collections.Generic", "CollectionExtensions", "GetValueOrDefault", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TValue>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TKey>::get()}, dictionary, key));
    }
    ...
    static TValue GetValueOrDefault(System::Collections::Generic::IReadOnlyDictionary_2<TKey, TValue>* dictionary, TKey key, TValue defaultValue) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<TValue>("System.Collections.Generic", "CollectionExtensions", "GetValueOrDefault", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TValue>::get(), il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TKey>::get()}, dictionary, key, defaultValue));
    }
