...
namespace UnityEngine {
  ...
  class _AndroidJNIHelper : public ::Il2CppObject {
    ...
    static ArrayType ConvertFromJNIArray(System::IntPtr array) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<ArrayType>("UnityEngine", "_AndroidJNIHelper", "ConvertFromJNIArray", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ArrayType>::get()}, array));
    }
    ...
    static System::IntPtr GetFieldID(System::IntPtr jclass, ::Il2CppString* fieldName, bool isStatic) {
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<System::IntPtr>("UnityEngine", "_AndroidJNIHelper", "GetFieldID", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ReturnType>::get()}, jclass, fieldName, isStatic));
    }
