...
namespace TMPro {
  ...
  class TMP_SubMeshUI : public UnityEngine::UI::MaskableGraphic, public UnityEngine::UI::IClippable, public UnityEngine::UI::IMaskable, public UnityEngine::UI::IMaterialModifier {
    public:
