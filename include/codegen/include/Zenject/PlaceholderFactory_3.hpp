...
namespace Zenject {
  // Autogenerated type: Zenject.PlaceholderFactory`3
  template<typename TValue, typename TParam1, typename TParam2>
  class PlaceholderFactory_3 : public Zenject::PlaceholderFactoryBase_1<TValue>, public Zenject::IFactory_3<TParam1, TParam2, TValue>, public Zenject::IFactory {
    public:
    // Nested type: Zenject::PlaceholderFactory_3::$get_ParamTypes$d__2<TParam1, TParam2, TValue>
    class $get_ParamTypes$d__2;
    // Autogenerated type: Zenject.PlaceholderFactory`3/<get_ParamTypes>d__2
    class $get_ParamTypes$d__2 : public ::Il2CppObject, public ::il2cpp_utils::il2cpp_type_check::NestedType, public System::Collections::Generic::IEnumerable_1<System::Type*>, public System::Collections::IEnumerable, public System::Collections::Generic::IEnumerator_1<System::Type*>, public System::Collections::IEnumerator, public System::IDisposable {
      public:
      using declaring_type = PlaceholderFactory_3<TValue, TParam1, TParam2>*;
      ...
      // Offset: 0x15D69CC
      static typename PlaceholderFactory_3<TParam1, TParam2, TValue>::$get_ParamTypes$d__2* New_ctor(int $$1__state) {
        return (typename PlaceholderFactory_3<TParam1, TParam2, TValue>::$get_ParamTypes$d__2*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<typename PlaceholderFactory_3<TParam1, TParam2, TValue>::$get_ParamTypes$d__2*>::get(), $$1__state));
      }
    ...
    }; // Zenject.PlaceholderFactory`3/<get_ParamTypes>d__2
    // public TValue Create(TParam1 param1, TParam2 param2)
    // Offset: 0x15D6C60
    TValue Create(TParam1 param1, TParam2 param2) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<TValue>(this, "Create", param1, param2));
    }
    ...
    static PlaceholderFactory_3<TValue, TParam1, TParam2>* New_ctor() {
      return (PlaceholderFactory_3<TValue, TParam1, TParam2>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PlaceholderFactory_3<TValue, TParam1, TParam2>*>::get()));
    }
  }; // Zenject.PlaceholderFactory`3
}
