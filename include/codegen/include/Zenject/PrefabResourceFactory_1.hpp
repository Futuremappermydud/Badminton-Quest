...
namespace Zenject {
  ...
  template<typename T>
  class PrefabResourceFactory_1 : public ::Il2CppObject, public Zenject::IFactory_2<::Il2CppString*, T>, public Zenject::IFactory {
    public:
    ...
    T Create(::Il2CppString* prefabResourceName) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<T>(this, "Create", prefabResourceName));
    }
    ...
    static PrefabResourceFactory_1<T>* New_ctor() {
      return (PrefabResourceFactory_1<T>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PrefabResourceFactory_1<T>*>::get()));
    }
