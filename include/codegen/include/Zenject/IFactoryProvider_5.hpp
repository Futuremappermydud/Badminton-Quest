...
namespace Zenject {
  // Autogenerated type: Zenject.IFactoryProvider`5
  ...
  class IFactoryProvider_5 : public Zenject::IFactoryProviderBase_1<TContract> {
    ...
    static IFactoryProvider_5<TContract, TParam1, TParam2, TParam3, TParam4>* New_ctor(Zenject::DiContainer* container, System::Guid factoryId) {
      return (IFactoryProvider_5<TContract, TParam1, TParam2, TParam3, TParam4>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<IFactoryProvider_5<TContract, TParam1, TParam2, TParam3, TParam4>*>::get(), container, factoryId));
    }
