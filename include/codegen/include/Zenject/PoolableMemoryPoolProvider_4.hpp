...
namespace Zenject {
  ...
  class PoolableMemoryPoolProvider_4 : public Zenject::PoolableMemoryPoolProviderBase_1<TContract>, public Zenject::IValidatable {
    ...
    static PoolableMemoryPoolProvider_4<TContract, TParam1, TParam2, TMemoryPool>* New_ctor(Zenject::DiContainer* container, System::Guid poolId) {
      return (PoolableMemoryPoolProvider_4<TContract, TParam1, TParam2, TMemoryPool>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<PoolableMemoryPoolProvider_4<TContract, TParam1, TParam2, TMemoryPool>*>::get(), container, poolId));
    }
