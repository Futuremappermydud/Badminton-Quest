...
namespace Zenject {
  ...
  // Skipping declaration: FactoryFromBinder`1 because it is already included!
...
namespace Zenject {
  ...
  class FactoryToChoiceBinder_1 : public Zenject::FactoryFromBinder_1<TContract> {
    ...
    Zenject::FactoryFromBinder_1<TContract>* ToSelf() {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<Zenject::FactoryFromBinder_1<TContract>*>(this, "ToSelf"));
    }
    ...
    Zenject::FactoryFromBinderUntyped* To(System::Type* concreteType) {
      return CRASH_UNLESS(il2cpp_utils::RunMethod<Zenject::FactoryFromBinderUntyped*>(this, "To", concreteType));
    }
    ...
    Zenject::FactoryFromBinder_1<TConcrete>* To() {
      ...
      return CRASH_UNLESS(il2cpp_utils::RunGenericMethod<Zenject::FactoryFromBinder_1<TConcrete>*>(this, "To", {il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<TConcrete>::get()}));
    }
    ...
    static FactoryToChoiceBinder_1<TContract>* New_ctor(Zenject::DiContainer* container, Zenject::BindInfo* bindInfo, Zenject::FactoryBindInfo* factoryBindInfo) {
      return (FactoryToChoiceBinder_1<TContract>*)CRASH_UNLESS(il2cpp_utils::New(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<FactoryToChoiceBinder_1<TContract>*>::get(), container, bindInfo, factoryBindInfo));
    }
